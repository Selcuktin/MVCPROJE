...
INSTALLED_APPS = [
    ...
    # Third party apps
    'rest_framework',
    # 'rest_framework_simplejwt.token_blacklist',  # JWT blacklist - Geçici olarak devre dışı
    'django_filters',
    'crispy_forms',
    'crispy_bootstrap5',
    # Local apps
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # 'rest_framework_simplejwt.authentication.JWTAuthentication',  # JWT eklendi - Geçici olarak devre dışı
    ],
