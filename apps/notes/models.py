"""
DOSYA: apps/notes/models.py
AMAÇ: Not yönetim sistemi - Sınav notlarını saklar
KULLANIM: Note modeli
- Sınav türleri: Vize, Final, Bütünleme
- Puan (0-100) → Harf notu (AA, BA, BB, ..., FF) otomatik dönüşüm
- Unique constraint: (course, student, exam_type) - Her öğrenci her sınav türü için tek not
